// Ported from packages/plugins/voice-mode/src/worker/sentence-buffer.test.ts
// (and ui/src/hooks/sentence-buffer.test.ts) for server-side copy (FRE-1296).
import { describe, it, expect } from "vitest";
import { splitIntoSentences } from "../services/voice/sentence-buffer.js";
